...
export const HeadUser = ({ size = "small" }) => (
  <AssignmentIndIcon fontSize={size} />
);
...
export const UserPlus = ({ size = "small" }) => (
  <PersonAddIcon fontSize={size} />
);

export const UserDisable = ({ size = "default" }) => (
  <PersonAddDisabledIcon fontSize={size} />
);
...
export const Location = () => <LocationOnIcon />;

export const Airport = () => <LocalAirportIcon />;
...
export const PlusOutline = ({ size = "default" }) => (
  <AddCircleOutlineSharpIcon fontSize={size} />
);
...
export const Chat = ({ size = "default" }) => (
  <TelegramIcon fontSize={size} />
);

export const Send = () => <SendIcon />;

export const Back = () => <ArrowBackIcon />;

export const Setting = ({ size = "default" }) => (
  <SettingsOutlinedIcon fontSize={size} />
);
...
export const DeleteText = ({ size = "default" }) => (
  <DeleteSweepIcon fontSize={size} />
);

export const DeleteCircle = ({ size = "small" }) => (
  <HighlightOffIcon fontSize={size} />
);

export const PageNone = ({ size = "large" }) => (
  <NoSimIcon fontSize={size} />
);
...
export const ArrowLeft = ({ size = "default" }) => (
  <SubdirectoryArrowLeftIcon fontSize={size} />
);

export const ArrowRight = ({ size = "default" }) => (
  <SubdirectoryArrowRightIcon fontSize={size} />
);
