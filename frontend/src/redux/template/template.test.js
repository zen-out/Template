...
describe("template", () => {
  ...
  it("thunk should get all", async () => {
    ...
    // console.log(storeMocked.getState().template);
    expect(storeMocked.getState().template).toEqual(
      initialState
    );
  });
  ...
  it("should add template", () => {
    ...
    expect(store.getState().template).toEqual(afterAdd);
  });
  ...
  it("should update", () => {
    ...
    // assert
    expect(store.getState().template).toEqual(afterEdit);
  });
  ...
  it("should change condition", () => {
    ...
    // assert
    expect(store.getState().template).toEqual(afterToggle);
  });
  it("should remove template", () => {
    ...
    // assert
    expect(store.getState().template).toEqual(afterDelete);
  });
});
